...
database = r"D:\PhD\Year_4\AlgorithmNew\DBTFB\Databases\TFB_Static_Polynomial_bounded_1.00 - V2.db"
...
#
bestFit2 = list(chunks(bestFit, 5))
numEval2 = list(chunks(numEval, 5))
bestRwp2 = list(chunks(bestRwp, 5))
#
# # print(bestFit2)
# # print(numEval2)
#
...
#
# plt.savefig(r"D:\PhD\Year_4\AlgorithmNew\DBTFB\Graphs\Static\indpb_1.00\rwp", dpi=300)
...
plt.savefig(r"D:\PhD\Year_4\AlgorithmNew\DBTFB\Graphs\Static\indpb_1.00\numEvals", dpi=300)
